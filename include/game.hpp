...
struct tetromino_instance
{
	...
	//m_tetromino_type is a variable to store enum
	coords m_pos;
...
public:
	...
	// In the function declaration auto init_game() const -> bool, the -> symbol is part of the trailing return type syntax introduced in C++11. It's used to specify the return type of the function.
...
private:
	...
	auto summon_tetromino_to_board(board &p_board, const tetromino_instance &p_tetromino_instance) -> void;
	enum class state
	{
		title_screen,
		playing,
